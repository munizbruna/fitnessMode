...
const WORKOUT_PLAN = {
    ...
    3: {
        ...
        videoUrl: "https://stream.scaleup.com.br/player/v1/playlists/c225a2e2c990a187487b8cff1196bdb8c5cd8fc6?URLPrefix=1772460049&Expires=1772460049&Signature=23fa0be8076dd613d8220bbe168947516cf86a4f&accessToken=af2acdf2-1f00-3cf2-8f91-6a9185cddb0e&authorization=eyJhbGciOiJIUzUxMiJ9..74xvowyfEienWXlgnumhhBkh920bldZ4NftM7btmOwUFd7IRTDXFr6UBJI24QMN0Jt9-LbeH5ClJjvuzQQDk0Q",
        exercises: [
            { id: 't3_aq', type: 'single', title: 'Aquecimento', summary: '5 desenvolvimento + 10 agachamentos + 15 do chão pra cima da cabeça (3x) *usando uma anilha*
', items: [{ name: 'Desenv + Agach + Chão', details: '3x (5+10+15)' }], restTime: 0, specialAction: { label: 'Ver Explicação (00:00)', time: 0 } },
